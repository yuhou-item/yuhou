  ...
  <div>
    <b-container>
      <b-row>
        ...
        <router-link to="/" class="m-text">back</router-link>
      </b-row>
      <b-row>
...
export default {
  ...
  data() {
    return {
      ...
      image_list: [
        "https://dss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2132020113,4152666483&fm=26&gp=0.jpg",
      ], //搜索到的歌曲的两张图
        ...
        success: function(songs) {
          ...
          that.song_msg = MiniApp.getSongs({
            ...
            success: function(res) {
              ...
              then.song_length = parseInt(
                res.song_data_list[0].audio_info.duration
              );
              //并且设置播放起始位置为0
              then.song_value = 0;
            },
          ...
          for (let i = 0; i < songs.song_data_list.length; i++)
            that.image_list.push(
              songs.song_data_list[i].album_sizable_cover.replace("{size}/", "")
            );
